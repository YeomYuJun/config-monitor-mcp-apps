...
const I18N: Record<string, Record<string, string>> = {
  ko: {
    ...
    presetPresent: "있는 것만", presetCommon: "주로 쓰는 것",
    presetAll: "전체", presetCustom: "직접 선택",
  ...
  en: {
    ...
    presetPresent: "Only what exists", presetCommon: "Commonly used",
    presetAll: "All", presetCustom: "Choose",
