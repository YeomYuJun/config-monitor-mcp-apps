...
const I18N: Record<string, Record<string, string>> = {
  ko: {
    ...
    snapshot: "스냅샷", refresh: "새로고침", openBrowser: "브라우저에서 열기",
    dispSettings: "표시 설정", accentColor: "강조 색상", showSources: "출처 경로 표시", descLines: "설명 표시 줄 수", linesSuffix: "줄",
    fullscreen: "전체화면", windowed: "창 모드",
    watcherOn: "watcher 실행 중", watcherOff: "watcher 정지", watcherStale: "watcher 응답 없음", watcherStaleTip: "마지막 heartbeat",
    ...
    projPickOpen: "＋ 프로젝트에서 추가", projPickEmpty: ".claude 있는 프로젝트 없음", projPickTracked: "추적 중", projPickNoClaude: ".claude 없음",
    ...
    gcTitle: "스냅샷 정리", gcHint: "90일 지난 스냅샷과 미참조 객체", gcScan: "정리", gcRun: "삭제", gcNothing: "정리할 항목 없음",
    gcPlan: "정리 대상", gcDone: "정리 완료", gcSnaps: "스냅샷", gcObjs: "객체",
    formatOnlyDiff: "의미 있는 내용은 같습니다. 들여쓰기·공백 같은 표기만 다릅니다.",
    ignoredOnlyDiff: "무시 목록 항목만 다릅니다", ignoredAlso: "# 무시 목록 항목도 바뀜", rawDiff: "원문 diff",
    noDiff: "선택한 두 버전 사이에 텍스트 변경이 없습니다.", noSnapshotDiff: "아직 스냅샷이 없습니다.",
    bothAbsentDiff: "두 버전 모두 이 파일의 내용이 없습니다(추적 안 됨/삭제됨).",
    ...
    toastRefreshed: "새로고침 완료", toastBrowser: "브라우저에서 열기",
    ...
    toastTabOpened: "브라우저 탭 열림", toastOpenFail: "열기 실패",
    ...
    secShow: "섹션 표시", hideEmpty: "빈 섹션 숨기기", showMissingProj: ".claude 없는 프로젝트 표시",
    ...
    "err.cache_unavailable": "플러그인 카탈로그 캐시를 읽을 수 없습니다", "err.tool_missing": "필요한 프로그램(git 또는 claude)이 PATH 에 없습니다",
    "err.external_failed": "외부 명령이 실패했습니다: {target}", "err.store_uninitialized": "스냅샷 스토어가 초기화되지 않았습니다",
    "err.lock_timeout": "다른 작업이 스토어 락을 잡고 있어 기다리다 중단했습니다", "err.internal": "내부 오류",
  ...
  en: {
    ...
    snapshot: "Snapshot", refresh: "Refresh", openBrowser: "Open in browser",
    ...
    watcherOn: "watcher running", watcherOff: "watcher stopped", watcherStale: "watcher not responding", watcherStaleTip: "last heartbeat",
    ...
    projPickOpen: "＋ Add from projects", projPickEmpty: "No projects with .claude", projPickTracked: "tracked", projPickNoClaude: "no .claude",
    ...
    gcTitle: "Snapshot cleanup", gcHint: "Snapshots past 90 days and unreferenced objects", gcScan: "Clean up", gcRun: "Delete", gcNothing: "Nothing to clean",
    gcPlan: "Would remove", gcDone: "Cleanup done", gcSnaps: "snapshots", gcObjs: "objects",
    formatOnlyDiff: "Significant content is identical; only formatting (indentation, whitespace) differs.",
    ignoredOnlyDiff: "Only ignored keys differ", ignoredAlso: "# ignored keys also changed", rawDiff: "raw diff",
    noDiff: "No text changes between the selected versions.", noSnapshotDiff: "No snapshot yet.",
    bothAbsentDiff: "Neither version has content for this file (not tracked or deleted).",
    ...
    toastRefreshed: "Refreshed", toastBrowser: "Opening in browser",
    ...
    toastTabOpened: "Browser tab opened", toastOpenFail: "Open failed",
    ...
    secShow: "Sections", hideEmpty: "Hide empty sections", showMissingProj: "Show projects without .claude",
    ...
    "err.cache_unavailable": "Cannot read the plugin catalog cache", "err.tool_missing": "Required program (git or claude) is not on PATH",
    "err.external_failed": "External command failed: {target}", "err.store_uninitialized": "Snapshot store is not initialized",
    "err.lock_timeout": "Gave up waiting for a store lock held by another operation", "err.internal": "Internal error",
