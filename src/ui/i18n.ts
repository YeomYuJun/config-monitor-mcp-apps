...
const I18N: Record<string, Record<string, string>> = {
  ko: {
    ...
    gcTitle: "스냅샷 정리", gcHint: "90일 지난 스냅샷과 미참조 객체", gcScan: "대상 계산", gcRun: "삭제", gcNothing: "정리할 항목 없음",
  ...
  en: {
    ...
    gcTitle: "Snapshot cleanup", gcHint: "Snapshots past 90 days and unreferenced objects", gcScan: "Compute", gcRun: "Delete", gcNothing: "Nothing to clean",
